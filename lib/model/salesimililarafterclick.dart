...
//
//     final salesimilarAfterlClick = salesimilarAfterlClickFromJson(jsonString);

import 'dart:convert';

SalesimilarAfterlClick salesimilarAfterlClickFromJson(String str) => SalesimilarAfterlClick.fromJson(json.decode(str));

String salesimilarAfterlClickToJson(SalesimilarAfterlClick data) => json.encode(data.toJson());

class SalesimilarAfterlClick {
    SalesimilarAfterlClick({
        //this.meta,
        this.properties,
    });
   ...
   // Meta meta;
    ...
    factory SalesimilarAfterlClick.fromJson(Map<String, dynamic> json) => SalesimilarAfterlClick(
...
class Property {
    ...
    factory Property.fromJson(Map<String, dynamic> json) => Property(
        ...
        // floorPlans: List<FloorPlan>.from(json["floor_plans"].map((x) => FloorPlan.fromJson(x))),
...
class Management {
    ...
    factory Management.fromJson(Map<String, dynamic> json) => Management(
        ...
        hours: json["hours"] == null ? null : List<Hour>.from(json["hours"].map((x) => Hour.fromJson(x))),
    );
...
class School {
    ...
    factory School.fromJson(Map<String, dynamic> json) => School(
        ...
        name: json["name"],
        educationLevels: List<String>.from(json["education_levels"].map((x) => x)),
        fundingType: json["funding_type"],
        lat: json["lat"].toDouble(),
        lon: json["lon"].toDouble(),
        studentCount: json["student_count"] == null ? null : json["student_count"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "name": name,
        "education_levels": List<dynamic>.from(educationLevels.map((x) => x)),
        "funding_type": fundingType,
        "lat": lat,
        "lon": lon,
        "student_count": studentCount == null ? null : studentCount,
