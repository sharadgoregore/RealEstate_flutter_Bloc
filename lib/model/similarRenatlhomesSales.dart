...
//
//     final similarSalesHouse = similarSalesHouseFromJson(jsonString);

import 'dart:convert';

SimilarSalesHouse similarSalesHouseFromJson(String str) => SimilarSalesHouse.fromJson(json.decode(str));

String similarSalesHouseToJson(SimilarSalesHouse data) => json.encode(data.toJson());

class SimilarSalesHouse {
    SimilarSalesHouse({
        this.properties,
    });
    ...
    factory SimilarSalesHouse.fromJson(Map<String, dynamic> json) => SimilarSalesHouse(
